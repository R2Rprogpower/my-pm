...
(function ($) {
  Drupal.behaviors.timesheets = {
    attach: function (context, settings) {
      ...
      function success_ajax(timesheetsInfoJson) {
        console.log(timesheetsInfoJson);
      }
...
//          // $('#ajax_target').hide();
          ...
          var settings = {url: url_get_timesheets_info, data: data, dataType: 'html', success: function (timesheetsInfoJson) {success_ajax(timesheetsInfoJson)},};
          var ajax = new Drupal.ajax(false, false, settings);
          console.log(ajax);
          
          
          var output =  ajax.eventResponse(ajax, {});
          console.log(output);
