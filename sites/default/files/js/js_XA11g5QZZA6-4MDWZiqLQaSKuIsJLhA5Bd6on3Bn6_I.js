  ...
  Drupal.behaviors.style = {
    attach: function (context, settings) {
     ...
     // $('li.next').css('font-size', '6px'); 
      ...
      //});
         var endOfTheFunc2 = Date.now();
         var time2 = (endOfTheFunc2 - startOfTheFunc2)/1000;
         console.log('Time needed to style user page' + time2 + ' seconds'); 
          ...
          $.ajax({
            ...
            success: function (timesheetsInfoJson) {
              ...
              $.each(totalSum, function(index, data){ 
               ...
               var endOfTheFunc = Date.now();
               console.log(startOfTheFunc);
               var time = (endOfTheFunc - startOfTheFunc)/1000;
             console.log('Time needed to download and display time sheets ' + time + ' seconds'); 
            }
          }); 
                ...
                $.ajax({
                  ...
                  success: function (projectNid) {
                    ...
                    $.each(totalSum, function(index, data){ 
                      ...
                      var endOfTheFunc2 = Date.now();
                      var time2 = (endOfTheFunc2 - startOfTheFunc2)/1000;
                      console.log('Time needed for instaAddTimesheets and to download and display time sheets ' + time2 + ' seconds'); 
                   }   
                });
              } 
            });
