...
(function ($) {
  Drupal.behaviors.timesheets = {
    attach: function (context, settings) {
//      var timesheetsViewId =   $('.view-id-timesheets').attr('class').split(' ')[4];
//      var timesheetsViewSelector = '.' + timesheetsViewId;
        ...
        if (pathSplit[3] == 'timesheets' || pathSplit[2] == 'timesheets') {
          ...
          $.ajax({
            ...
            success: function (timesheetsInfoJson) {
              ...
              var end = Date.now();;
              console.log('timesheets info display - ' +end-start);
            }
          }); 
...
Drupal.behaviors.timesheets1 = {
  attach: function (context, settings) {
    $('#abra').find('a').once().click(function(e) {
      e.preventDefault();
